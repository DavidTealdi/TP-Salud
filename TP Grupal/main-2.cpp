...
*/
bool validarFecha(int & dia, int & mes, int & anio, fecha & fechaAConsiderar){
...
fecha solicitarFecha(fecha & fechaConsiderar){
    
    int anio, mes, dia; fecha nueva; bool validacion;
...
bool tieneTurnosEspecialidad(int & codigoBuscado, int & dlAgenda, turno agenda[]){
    ...
    for(int i=0; i<=dlAgenda; i++){
        ...
        if(agenda[i].codigoEspecialidad==codigoBuscado && agenda[i].estado==1){
            return true;
        }
    }
...
void Listado_de_Especialidades_Medicas_completo(){
    ...
    cout<<endl;
    cout<<"Se mostraron las Especialidades Medicas completo"<<endl;
    system("pause");
    cout<<endl;
};
...
void Listado_de_Especialidades_Medicas_por_busqueda(){
    ...
    cout<<endl;
    cout<<"Mostrará la especialidad medica que se ha solicitado por medio de un código unico"<<endl;
    system("pause");
    cout<<endl;
};
...
void Listado_de_Pacientes_completo(){
    ...
    cout<<endl;
    cout<<"Se ha mostrado la lista de pacientes completo"<<endl;
    system("pause");
    cout<<endl;
};
...
void Alta_de_Turnos(turno agenda[], paciente fichas[], int & dlPacientes, int & dlEspecialidades, int & dlTurno, fecha fechaActual){
...
void Modificacion_de_Turnos(paciente fichas[], int & dlPacientes, turno agenda[], int & dlAgenda, fecha hoy){
    
    int dniPaciente, codigoModificar; char eleccion;
    struct turno modificaciones;
...
void Baja_de_Turnos(paciente fichas[], int & dlPacientes, turno agenda[], int & dlAgenda, fecha hoy){
...
void Listado_de_Turnos_por_busqueda(){
    ...
    cout << "" <<endl;
    cout << "Se ha mostrado la lista de pacientes por busqueda" <<endl;
    system("pause");
    cout << "" <<endl;
        ...
        switch(eleccion){
            ...
            case '4':
                do{
                    ...
                    default:
                        cout<<"***Opción Invalida***"<<endl<<"Reingrese una opcion (A o B): ";
                        break;
                    };
                }while(subEleccion!='a' or subEleccion!='b');
            break;
...
void submenuAdministrarTurnos(turno agenda[], paciente fichas[], int & dlPacientes, int & dlEspecialidades, int & dlTurno, fecha diaDeHoy){
